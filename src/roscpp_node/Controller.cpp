...
namespace vsc_uav_target_tracking
{
        ...
        : nh_(nh), pnh_(pnh)
    {
        ...
        // Flag to indicate whether altitude data has been received
        altitude_received = false;
        // Flag to indicate whether custom TF features have been received
        custom_tf_features_received = false;
        // Flag to indicate whether custom features have been received
        custom_features_received = false;
    ...
    void Controller::featureCallback_poly_custom_tf(const img_seg_cnn::PolyCalcCustomTF::ConstPtr &s_message)
    {
        ...
        // Set custom TF features flag to true
        custom_tf_features_received = true;
    }
    ...
    void Controller::featureCallback_poly_custom(const img_seg_cnn::PolyCalcCustom::ConstPtr &s_message)
    {
        ...
        // Set custom features flag to true
        custom_features_received = true;
    }
    ...
    void Controller::update()
    {
        ...
        while (ros::ok())
        {
            // cout << "Just outside the if statement in the update() function" << endl;
            // cout << "flag: " << flag << endl;
            // cout << "altitude_received = " << altitude_received << endl;
            // cout << "custom_tf_features_received = " << custom_tf_features_received << endl;
            // cout << "custom_features_received = " << custom_features_received << endl;
            ...
            if (altitude_received == 1 && custom_tf_features_received == 1 && custom_features_received == 1)
            {
                cout << "Inside the if statement in the update() function" << endl;
                // cout << "flag: " << flag << endl;
                // cout << "altitude_received = " << altitude_received << endl;
                // cout << "custom_tf_features_received = " << custom_tf_features_received << endl;
                // cout << "custom_features_received = " << custom_features_received << endl;
                // cout << "opencv_moments: " << opencv_moments << endl;
            ...
            {
                // Not all necessary data has been received, wait for the next update cycle
                // ROS_INFO("Waiting for all necessary data to be received...");
            }
        }
    }
} // namespace vsc_uav_target_tracking
